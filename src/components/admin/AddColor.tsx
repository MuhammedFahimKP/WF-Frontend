...
const AddVaraitonPage = ({ id }: { id: string }) => {
  return (
    <div
     ...
     border-gray-200 h-20   md:h-96 w-72 grid  flex-col items-center justify-center overflow-hidden rounded-xl   text-center text-gray-700"
    >
      <Link
      ...
      >
        <MdOutlineAddCircle className="size-10  md:size-20 text-gray-500" />
      </Link>

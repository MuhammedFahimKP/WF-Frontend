...
const ProductViewPage = () => {
  ...
  const { data: brands } = useData<AdminBrand>(
    "admin/brand/",
    0,
    undefined,
    true
  );
  const { data: categoery } = useData<AdminCategory>(
    "admin/categoery/",
    0,
    undefined,
    true
    ...
    <>
      <section className="container mx-auto px-4 md:px-6 py-8">
        ...
        <div className="mt-14 ">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 place-items-center py-4 gap-6 mx-4 ">
            <AddColor id={id ? id : ""} />

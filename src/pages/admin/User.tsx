...
import UserAddForm from "@/ui/admin/user/UserAddForm";
...
const User = () => {
  ...
  return (
    <div className="w-full   min-h-screen">
      <div className="flex flex-col   h-[35%]  lg:h-48  bg-white px-8 py-0 text-black ">
        <div className="mt-4 flex items-center justify-between lg:mt-8 h-fit   mb-10  ">
          <h1 className="text-4xl  lg:text-4xl">Users</h1>
          <button
            onClick={handleForm}
      ...
      {form && <UserAddForm form={form} handleForm={handleForm} />}
    </div>
  );
};

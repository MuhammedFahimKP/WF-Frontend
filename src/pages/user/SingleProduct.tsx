...
import Magnfier from "@/components/user/Magnifier";
...
const SingleProduct = () => {
  ...
  const [error, setError] = useState<null | ApiClientError>(null);
  ...
  return error?.status === 404 || varaints?.length === 0 ? (
      ...
      <div className="max-w-7xl mx-auto lg:p-8">
        <div className="flex flex-col   justify-between lg:flex-row gap-16 lg:items-center ">
          <div className="flex flex-col gap-6 ">
            {activeImg != "" && (
              <Magnfier
                classes="w-full h-[500px]   object-contain overflow-hidden  bg-clip-border rounded-xl"
                src={activeImg}
              />
            )}
          ...
          {/* ABOUT */}
          <div className="flex flex-col-reverse md:flex-col md:gap-4 gap-2  lg:w-2/4 p-8 ">
            <div className="flex flex-col-reverse md:flex-col my-4 gap-2">
              <div>
